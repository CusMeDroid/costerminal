...
# Deskripsi
COS Terminal adalah sebuah perintah dengan tampilan terminal/Command Prompt yang dikembangkan oleh Suryo Dwijayanto, Bertujuan agar masyarakat lebih mengenal manfaat teknologi, dengan harapan mempermudah/membantu. COS Terminal ada karena [CusMe OS](https://cusme-os.web.app), sebuah simulasi Operasi Sistem Berbasis web app. Base COS Terminal .bat jadi fungsi command prompt pada windows harusnya dapat digunakan dengan baik, Kami hanya membuat tampilannya lebih berbeda dan beberapa perintah untuk menjalankan aplikasi lain yang kami buat.
